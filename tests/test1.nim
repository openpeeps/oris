...
suite "Oris Unit Tests":
  ...
  test "Pluralization":
    ...
    check i18n.translatePlural("animals", [("dogs", 1), ("cats", 2)]) == "one dog and 2 cats"
    check i18n.translatePlural("animals", [("dogs", 3), ("cats", 1)]) == "3 dogs and one cat"
  ...
  test "Serialization and Deserialization":
    ...
    check decodedLang.translatePlural("animals", [("dogs", 1), ("cats", 2)]) == "one dog and 2 cats"
    check decodedLang.translatePlural("animals", [("dogs", 3), ("cats", 1)]) == "3 dogs and one cat"
  ...
  test "Fallback for Missing Plural Rules":
    ...
    check i18n.translatePlural("animals", [("dogs", 2), ("cats", 3)]) == "$dogs and 3 cats"
